...
class CartSuggestionVehicleService extends Api {
  //
  // *----- get vehicles
  Future<ResponseModel> getVehicles(
    ...
    ResponseModel response = await HTTPGET(
      RoutingProduct.Get_CartSuggestionVehicle,
      queries,
      null,
    ...
    if (response.isSuccess) {
      response.data = CartSuggestionVehiclePagingModel.fromJson(response.data);
    }
